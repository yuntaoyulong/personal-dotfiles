...
copy "$HOME_DIR/.config/systemd/user/mail-sync-notify.service" "$ROOT/config/systemd/user/mail-sync-notify.service"
copy "$HOME_DIR/.config/systemd/user/mail-sync-notify.timer" "$ROOT/config/systemd/user/mail-sync-notify.timer"
...
rm -rf "$ROOT/config/systemd/user/default.target.wants"
rm -rf "$ROOT/config/systemd/user/timers.target.wants"
rm -rf "$ROOT/config/systemd/user/sockets.target.wants"
rm -f "$ROOT/config/systemd/user/pipewire-session-manager.service"
rm -rf "$ROOT/config/systemd/user/pipewire.service.wants"
